...
{
    public class polygonsonversion
    {
        public polygonsonversion()
        { }
        ...
        public polygonsonversion(int isArea, long objectid, long id, int version, int versionsub, int versionfinal, long userid, string username, double userReputation, long changeset, DateTime timestamp, string tags, string pointids, string points, double trustValue, string geom, double areaV, double areaG, double centroidX, double centroidY, decimal areadiffsim, decimal shapediffsim, string geomline,int count)
        {
            _isArea = isArea;
            _objectid = objectid;
            _id = id;
