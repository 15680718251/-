...
namespace GIS.RaToVe.ObjectVecRLE
{
    public class DPReduction
    {
        ...
        /// <returns></returns>
        public static List<GeoPoint> DouglasPeuckerReduction(List<GeoPoint> Points, Double Tolerance, int FirstIndex, int LastIndex)
        {
            Int32 firstPoint = FirstIndex;
            Int32 lastPoint = LastIndex;
            List<GeoPoint> returnPoints = new List<GeoPoint>();
            if (Points == null || (lastPoint - firstPoint + 1) < 3)
            {
            ...
            while (Points[firstPoint].IsEqual(Points[lastPoint]))
            {
                lastPoint--;
            }
        ...
        private static void DouglasPeuckerReduction(List<GeoPoint> points, Int32 firstPoint, Int32 lastPoint, Double tolerance, ref List<Int32> pointIndexsToKeep)
        {
