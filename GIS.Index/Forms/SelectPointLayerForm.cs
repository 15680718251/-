...
namespace GIS.TreeIndex.Forms
{
    ...
    public partial class SelectPointLayerForm : Form
    {
        public SelectPointLayerForm()
        {
            InitializeComponent();
        }
        ...
        public SelectPointLayerForm(MapUI ui)
        {
            InitializeComponent();
            for (int i = 0; i < ui.GroupCounts; i++)
            {
                ...
                for (int j = 0; j < group.Counts; j++)
                {
                    ...
                    if (layer.LayerTypeDetail == GIS.Layer.LAYERTYPE_DETAIL.PointLayer)
                    {
