...
namespace GISEditor.EditorTool.Tool
{
    ...
    /// </summary>  
  public  class CopyFeatureToolClass
    {
        ESRI.ArcGIS.esriSystem.UID CLSID = null;
        ESRI.ArcGIS.esriSystem.UID EXTCLSID = null;
        /// <summary>  
        ...
        public IFeatureClass CloneFeatureClassInWorkspace(IFeatureClass OldFeatureClass, IFeatureWorkspace SaveFeatWorkspace, string FeatClsName, IEnvelope pDomainEnv)
        {
            ...
            return SaveFeatWorkspace.CreateFeatureClass(FeatClsName, pFields, CLSID, EXTCLSID, esriFeatureType.esriFTSimple, OldFeatureClass.ShapeFieldName, "");
        }
        /// <summary>  
