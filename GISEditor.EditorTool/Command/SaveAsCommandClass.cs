...
namespace GISEditor.EditorTool.Command
{
    class SaveAsCommandClass:ICommand
    {
        ...
        public void OnClick()
        {
            ...
            if (bHasEdit)
            {
                ...
                {
                    string[] sFilePath = pSaveFileDialog.FileNames;

                    //IMapDocument pMapDocument = new MapDocumentClass();
                    //pMapDocument.New(sFilePath);
                    //pMapDocument.ReplaceContents(axMapControl1.Map as IMxdContents);
                    //pMapDocument.SaveAs(sFilePath, true, true);//这个类应该不需要了！！！！！！
                    //pMapDocument.Close();
                }
